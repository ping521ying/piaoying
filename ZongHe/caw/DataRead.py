...
def readyaml(filepath):
    ...
    :return: yaml中文件内容
    '''
    read_path = getProjectPath() + filepath # 拼接完整路径
    with open(read_path,"r",encoding="utf-8") as f: # 打开文件
        content = yaml.load(f,Loader= yaml.FullLoader) # 读取文件
        return  content
# 测试代码，用完可以删除
if __name__ == '__main__':
    ...
    content = readyaml(r"ZongHe/data_case/register_fial.yaml")
    print(content)